...
-- The FOR ALL policy from migration 20260406134036 restricts writes to admins only.
-- Replace it with separate INSERT/UPDATE/DELETE policies so budget_officer can
-- write budget data but cannot delete financial records.
...
INSERT INTO public.role_permissions (role, module, can_view, can_create, can_edit, can_delete) VALUES
  -- budget_officer: full workspace + financial modules
