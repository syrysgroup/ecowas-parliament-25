...
const staticEvents = [
  { id: "ev1", title: "Official Launch & Awards Nominations Open", description: "The 25th Anniversary programme is officially launched at a press conference in Abuja. Join leaders, parliamentarians, and youth champions for this historic moment.", date: "2026-03-05T09:00:00Z", end_date: "2026-03-05T17:00:00Z", location: "Onomo Allure Abuja AATC Hotel", country: "Nigeria", programme: "Awards", capacity: 300 },
  { id: "ev2", title: "ECOWAS Smart Challenge & Media Training Forum", description: "National youth innovation competitions in Ghana and Senegal with media training for 50+ journalists. Young innovators showcase solutions to regional challenges.", date: "2026-04-15T09:00:00Z", end_date: "2026-04-16T17:00:00Z", location: "Accra International Conference Centre", country: "Ghana", programme: "Youth", capacity: 500 },
  { id: "ev3", title: "Simulated Youth Parliament", description: "150+ young people from across West Africa debate policy issues in a simulated ECOWAS Parliament session. Experience democracy in action.", date: "2026-05-20T09:00:00Z", end_date: "2026-05-22T17:00:00Z", location: "Palais de la Culture, Abidjan", country: "Côte d'Ivoire", programme: "Parliament", capacity: 200 },
  { id: "ev4", title: "Trade & SME Forums", description: "B2B forums bringing together SME owners, investors, and policymakers across five cities. Discover trade opportunities and build partnerships.", date: "2026-08-10T09:00:00Z", end_date: "2026-08-12T17:00:00Z", location: "Multiple venues", country: "Nigeria", programme: "Trade", capacity: 400 },
  { id: "ev5", title: "West African Cultural & Creative Festival", description: "A week-long celebration of West African cultural diversity — fashion, film, food, literature, music, art, and sport.", date: "2026-09-15T09:00:00Z", end_date: "2026-09-21T22:00:00Z", location: "Praia Convention Centre", country: "Cabo Verde", programme: "Culture", capacity: 1000 },
  { id: "ev6", title: "Grand Finale & Awards Ceremony", description: "Leaders, partners, youth champions, and citizens gather for the closing ceremony and inaugural AWALCO Parliamentary Awards.", date: "2026-11-20T18:00:00Z", end_date: "2026-11-20T23:00:00Z", location: "ECOWAS Parliament Complex, Abuja", country: "Nigeria", programme: "Awards", capacity: 500 },
];

function generateICS(event: typeof staticEvents[0]) {
    ...
    try {
      if (user) {
        await (supabase as any).from("event_registrations").insert({
          event_id: event.id, user_id: user.id, name: form.name,
        ...
        <div className="container">
          <AnimatedSection>
            ...
            <div className="flex flex-wrap gap-4 mt-4 text-sm text-primary-foreground/70">
              ...
              <span className="flex items-center gap-1"><MapPin className="h-4 w-4" />{event.location}, {event.country}</span>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-10">
            <div className="space-y-8">
              <AnimatedSection>
                <img src={flier} alt={event.title} className="w-full rounded-2xl shadow-lg" loading="lazy" />
              </AnimatedSection>
              <AnimatedSection>
