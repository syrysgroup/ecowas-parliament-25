...
// Static events until DB is populated
const staticEvents = [
  {
    id: "ev1",
    title: "Official Launch & Awards Nominations Open",
    description: "The 25th Anniversary programme is officially launched at a press conference in Abuja.",
    date: "2026-03-05T09:00:00Z",
    location: "Onomo Allure Abuja AATC Hotel",
    country: "Nigeria",
    programme: "Awards",
    capacity: 300,
    is_published: true,
  },
  {
    ...
    description: "National youth innovation competitions in Ghana and Senegal with media training for 50+ journalists.",
  ...
  },
  {
    ...
    description: "150+ young people from across West Africa debate policy issues in a simulated ECOWAS Parliament session.",
  ...
  },
  {
    ...
    description: "B2B forums bringing together SME owners, investors, and policymakers across five cities.",
  ...
  },
  {
    ...
    description: "A week-long celebration of West African cultural diversity — fashion, film, food, literature, music, art, and sport.",
    date: "2026-09-15T09:00:00Z",
    location: "Praia Convention Centre",
    country: "Cabo Verde",
    programme: "Culture",
    capacity: 1000,
    is_published: true,
          ...
          {rsvpEvent && (
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div>
                ...
                <Input value={form.organisation} onChange={e => setForm(f => ({ ...f, organisation: e.target.value }))} placeholder="Company or institution" />
              </div>
