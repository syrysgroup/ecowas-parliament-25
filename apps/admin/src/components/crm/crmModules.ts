...
export const CRM_MODULES: CRMModule[] = [
  ...
  // ── ANALYTICS & FINANCE ───────────────────────────────────────────────────
  {
    ...
    icon: BarChart2,
    section: "analytics",
    allowedRoles: ["super_admin", "admin", "project_director", "marketing_manager", "budget_officer"],
    isStub: false,
  ...
  },
  {
    ...
    icon: DollarSign,
    section: "finance",
    allowedRoles: ["super_admin", "finance_coordinator", "budget_officer"],
    isStub: false,
    group: "ANALYTICS & FINANCE",
  },
  {
