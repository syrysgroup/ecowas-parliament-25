...
const SECTION_TEMPLATES: Record<string, { label: string; fields: { key: string; label: string; type: "text" | "textarea" }[] }> = {
  ...
  implementing_partners: {
    ...
    fields: [
      ...
      { key: "title",        label: "Section Title", type: "text" },
      { key: "title_accent", label: "Accent (highlighted) Title Word", type: "text" },
      { key: "subtitle",     label: "Subtitle (one line under title)", type: "text" },
      { key: "description",  label: "Section Description (legacy)", type: "textarea" },
    ],
  },
  institutional_partners: {
    label: "Institutional Partners Intro",
    fields: [
      { key: "badge",        label: "Eyebrow / Badge Text", type: "text" },
      { key: "title",        label: "Section Title", type: "text" },
      { key: "title_accent", label: "Accent (highlighted) Title Word", type: "text" },
  ...
  mandate: {
    label: "Homepage — People-Oriented Mandate",
    fields: [
      { key: "badge",         label: "Top Badge", type: "text" },
      { key: "title",         label: "Heading (before accent)", type: "text" },
      { key: "title_accent",  label: "Heading Accent Word", type: "text" },
      ...
      { key: "pillar1_desc",  label: "Pillar 1 — Description", type: "textarea" },
      { key: "pillar2_title", label: "Pillar 2 — Title", type: "text" },
      { key: "pillar2_desc",  label: "Pillar 2 — Description", type: "textarea" },
      { key: "pillar3_title", label: "Pillar 3 — Title", type: "text" },
      { key: "pillar3_desc",  label: "Pillar 3 — Description", type: "textarea" },
      { key: "pillar4_title", label: "Pillar 4 — Title", type: "text" },
      { key: "pillar4_desc",  label: "Pillar 4 — Description", type: "textarea" },
      { key: "quote",         label: "Closing Quote", type: "textarea" },
